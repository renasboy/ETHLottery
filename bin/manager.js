...
var manager_address = "0x450fa40f5537c34f1f5cfbb8329289e0a0299733";
...
var add_lottery = function (address) {
    ...
    lottery.Result(function(error, result) {
        ...
        if (result) {
            ...
            var accumulate = lottery.winners_count() ? false : true;
...
var reproduce_lottery = function (lottery, accumulate) {
    var accumulated = accumulate ? eth.getBalance(result.address) : 0;
